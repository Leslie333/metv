...
function tfuse_youtube($atts, $content = null)
{
    ...
    return '<div clas="video"><iframe width="' . $width . '" height="' . $height . '" src="http://www.youtube.com/embed/' . $video_id[0] . '?wmode=transparent" frameborder="0"></iframe></div>' . PHP_EOL;
}
...
function tfuse_vimeo($atts, $content)
{
    ...
    return '<div clas="video"><iframe src="http://player.vimeo.com/video/' . substr($link, 17, 8) . '?title=0&amp;byline=0&amp;portrait=0" width="' . $width . '" height="' . $height . '" frameborder="0"></iframe></div>' . PHP_EOL;
}
