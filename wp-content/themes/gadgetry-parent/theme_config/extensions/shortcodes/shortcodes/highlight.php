...
$atts = array(
    ...
    'options' => array(
        array(
            'name' => __('Class', 'tfuse'),
            'desc' => __('Specify classes of the shortcode
                <br /><b>predefined classes:</b> highlight_yellow, highlight_brown, highlight_blue, highlight_black, highlight_purple', 'tfuse'),
