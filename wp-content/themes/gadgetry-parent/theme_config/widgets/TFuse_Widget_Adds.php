...
class TFuse_Widget_Adds extends WP_Widget {
    ...
    <!--Ads-->
        <p>
            ...
            <br>
        <p>
            <label><h3><?php _e('Ad 336x280 :', 'tfuse'); ?></h3>
            <textarea class="widefat" rows="4" cols="1"><div class="adv adv_336"><a href="http://themefuse.com/"><img width="336" height="280" src="wp-content/themes/magazinish-parent/images/adv_336x280.jpg"></a></div></textarea>
            </label>
        </p>
        <p>
        <label><h3><?php _e('Ad 300x250 :', 'tfuse'); ?></h3>
            <textarea class="widefat" rows="4" cols="1"><div class="adv_boxed"><div class="adv adv_300"><a href="http://themefuse.com/"><img width="300" height="250" src="wp-content/themes/magazinish-parent/images/adv_300x250.jpg"></a></div></div></textarea>
        </label>
        </p>
        <p>
        <label><h3><?php _e('Ad 250x250 :', 'tfuse'); ?></h3>
            <textarea class="widefat" rows="4" cols="1"><div class="adv_250"><a href="<?php echo home_url(); ?>"><img width="250" height="250" src="wp-content/themes/magazinish-parent/images/adv_250x250.png"></a></div></textarea>
        </label>
        </p>
        <p>
            <label><h3><?php _e('Ad 125x125 :', 'tfuse'); ?></h3>
                <textarea class="widefat" rows="4" cols="1"><div class="adv_125"><a href="<?php echo home_url(); ?>"><img width="125" height="125" src="wp-content/themes/magazinish-parent/images/adv_125x125.png"></a></div></textarea>
            </label>
        </p>
        <p>
            <label><h3><?php _e('4 or more ads 125x125 :', 'tfuse'); ?></h3>
                <textarea class="widefat" rows="4" cols="1">
                    <div class="adv_125_box">
                        <a href="<?php echo home_url(); ?>"><div class="adv_125"><img width="125" height="125" src="wp-content/themes/magazinish-parent/images/adv_125x125.png"></a></div>
                        <a href="<?php echo home_url(); ?>"><div class="adv_125"><img width="125" height="125" src="wp-content/themes/magazinish-parent/images/adv_125x125.png"></a></div>
                        <a href="<?php echo home_url(); ?>"><div class="adv_125"><img width="125" height="125" src="wp-content/themes/magazinish-parent/images/adv_125x125.png"></a></div>
                        <a href="<?php echo home_url(); ?>"><div class="adv_125"><img width="125" height="125" src="wp-content/themes/magazinish-parent/images/adv_125x125.png"></a></div>
                        <div class="clear"></div>
        ...
        <label><h3><?php _e('Ad 160x600 :', 'tfuse'); ?></h3>
            <textarea class="widefat" rows="4" cols="1"><div class="adv_160"><a href="<?php echo home_url(); ?>"><img width="160" height="600" src="wp-content/themes/magazinish-parent/images/adv_160x600.png"></a></div></textarea>
        </label>
        <p>
