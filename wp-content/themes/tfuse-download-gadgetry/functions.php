...
class TF_THEME_DOWNLOAD extends Theme_Upgrader {
    ...
    public  $theme_name             = 'Gadgetry';
    public  $theme_prefix           = 'gadgetry';
    public  $new_theme_prefix       = 'gadgetry-parent'; // directory name of the new installed theme
    public  $new_theme_prefix_child = 'gadgetry-child';
    public  $theme_license          = '36ada5faf05bd133c8a3a298915145ab';
    private $check_url              = 'http://themefuse.com/update-themes/';
    public  $downloader_prefix      = 'tfuse-download-gadgetry'; // directory name, will be used for autodeletion
